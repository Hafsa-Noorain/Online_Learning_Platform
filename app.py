...
""".format(otp)
    ...
    server.login('hafsanoorain242@gmail.com', 'empr kygs cybi waad')
...
def send_new_course_email( email_content):
    email_address = 'hafsanoorain242@gmail.com'  # Your Gmail email address
    app_password = 'empr kygs cybi waad'  # Your app-specific password
